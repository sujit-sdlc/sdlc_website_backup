...
var elementorNotesConfig = {"route":{"title":"What is NFT and How It is Important for Creators and Businesses?","url":"\/?p=3348","note_url_pattern":"https:\/\/sdlccorp.com\/wp-admin\/admin.php?page=elementor-pro-notes-proxy&note-id={{NOTE_ID}}","post_id":3348,"is_elementor_library":false},"direction":"ltr","is_debug":false,"current_user_can":{"create":true,"create_users":true,"edit_users":true},"urls":{"admin_url_create_user":"https:\/\/sdlccorp.com\/wp-admin\/user-new.php","admin_url_edit_user":"https:\/\/sdlccorp.com\/wp-admin\/user-edit.php","avatar_defaults":{"24":"https:\/\/secure.gravatar.com\/avatar\/?s=24&d=mm&r=g","48":"https:\/\/secure.gravatar.com\/avatar\/?s=48&d=mm&r=g","96":"https:\/\/secure.gravatar.com\/avatar\/?s=96&d=mm&r=g"},"help_notes_features":"https:\/\/go.elementor.com\/app-notes"}};/*! For license information please see notes-app-initiator.min.js.LICENSE.txt */
...
if(keyval[0].indexOf("consent")>-1&&keyval[1]=="yes"){isCookiesYesAccepted=!0}})}catch(ex){console.log(ex)}
...
function trackUserJourney(){if(!checkIfCookiesYesIsAccepted())return!1;let userID=localStorage.getItem('userID');if(!userID){userID=generateUserID();localStorage.setItem('userID',userID)}
...
function sendDataToBackend(){if(!checkIfCookiesYesIsAccepted())return!1;const userID=localStorage.getItem('userID');const sessionStartTime=localStorage.getItem('sessionStartTime');const sessionEndTime=localStorage.getItem('sessionEndTime')
