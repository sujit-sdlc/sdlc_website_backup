...
class WPLE_Admin
{
    ...
    public function wple_menu_page()
    {
        ...
        if ( FALSE === get_option( 'wple_version' ) ) {
            ...
            if ( version_compare( get_option( 'wple_version' ), '6.0', '<=' ) ) {
                delete_option( 'wple_plan_choose' );
                update_option( 'wple_version', WPLE_PLUGIN_VER );
            }
...
<?php 
    ...
    public function wple_mixed_content_notice()
    {
      ...
      <a class="wple-lets-review wplerevbtn" href="https://wpencryption.com/hire-ssl-expert/?utm_source=wordpress&utm_medium=mx_hire_expert" target="_blank">' . esc_html__( 'Hire SSL Expert', 'wp-letsencrypt-ssl' ) . '</a>
